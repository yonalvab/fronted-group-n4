        ...
        <>
            <aside className=' w-[390px] h-[640px] bg-slate-300 rounded-3xl flex flex-col  gap-4 ' >
                ...
                <div className=' flex flex-col justify-center items-center gap-2 ' >
                    ...
                    <button
                        class="group flex items-center justify- w-11 h-11 bg-red-600 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-40 hover:rounded-lg active:translate-x-1 active:translate-y-1  " onClick={handleOpenModal}
                    >
                        <div
